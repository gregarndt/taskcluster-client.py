...
class QueueEvents(AsyncBaseClient):
    ...
    **Remark**, some message generated by timeouts maybe dropped if the
    ...
    def artifactCreated(self, *args, **kwargs):
        return self._makeTopicExchange({'exchange': 'artifact-created', 'name': 'artifactCreated', 'schema': 'http://schemas.taskcluster.net/queue/v1/artifact-created-message.json#', 'routingKey': [{'multipleWords': False, 'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'constant': 'primary', 'name': 'routingKeyKind', 'required': True}, {'multipleWords': False, 'summary': '`taskId` for the task this message concerns', 'name': 'taskId', 'required': True}, {'multipleWords': False, 'summary': '`runId` of latest run for the task, `_` if no run is exists for the task.', 'name': 'runId', 'required': True}, {'multipleWords': False, 'summary': '`workerGroup` of latest run for the task, `_` if no run is exists for the task.', 'name': 'workerGroup', 'required': True}, {'multipleWords': False, 'summary': '`workerId` of latest run for the task, `_` if no run is exists for the task.', 'name': 'workerId', 'required': True}, {'multipleWords': False, 'summary': '`provisionerId` this task is targeted at.', 'name': 'provisionerId', 'required': True}, {'multipleWords': False, 'summary': '`workerType` this task must run on.', 'name': 'workerType', 'required': True}, {'multipleWords': False, 'summary': '`schedulerId` this task was created by.', 'name': 'schedulerId', 'required': True}, {'multipleWords': False, 'summary': '`taskGroupId` this task was created in.', 'name': 'taskGroupId', 'required': True}, {'multipleWords': True, 'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'name': 'reserved', 'required': False}]}, *args, **kwargs)
    ...
    def taskCompleted(self, *args, **kwargs):
        return self._makeTopicExchange({'exchange': 'task-completed', 'name': 'taskCompleted', 'schema': 'http://schemas.taskcluster.net/queue/v1/task-completed-message.json#', 'routingKey': [{'multipleWords': False, 'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'constant': 'primary', 'name': 'routingKeyKind', 'required': True}, {'multipleWords': False, 'summary': '`taskId` for the task this message concerns', 'name': 'taskId', 'required': True}, {'multipleWords': False, 'summary': '`runId` of latest run for the task, `_` if no run is exists for the task.', 'name': 'runId', 'required': True}, {'multipleWords': False, 'summary': '`workerGroup` of latest run for the task, `_` if no run is exists for the task.', 'name': 'workerGroup', 'required': True}, {'multipleWords': False, 'summary': '`workerId` of latest run for the task, `_` if no run is exists for the task.', 'name': 'workerId', 'required': True}, {'multipleWords': False, 'summary': '`provisionerId` this task is targeted at.', 'name': 'provisionerId', 'required': True}, {'multipleWords': False, 'summary': '`workerType` this task must run on.', 'name': 'workerType', 'required': True}, {'multipleWords': False, 'summary': '`schedulerId` this task was created by.', 'name': 'schedulerId', 'required': True}, {'multipleWords': False, 'summary': '`taskGroupId` this task was created in.', 'name': 'taskGroupId', 'required': True}, {'multipleWords': True, 'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'name': 'reserved', 'required': False}]}, *args, **kwargs)
    ...
    def taskFailed(self, *args, **kwargs):
        return self._makeTopicExchange({'exchange': 'task-failed', 'name': 'taskFailed', 'schema': 'http://schemas.taskcluster.net/queue/v1/task-failed-message.json#', 'routingKey': [{'multipleWords': False, 'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'constant': 'primary', 'name': 'routingKeyKind', 'required': True}, {'multipleWords': False, 'summary': '`taskId` for the task this message concerns', 'name': 'taskId', 'required': True}, {'multipleWords': False, 'summary': '`runId` of latest run for the task, `_` if no run is exists for the task.', 'name': 'runId', 'required': False}, {'multipleWords': False, 'summary': '`workerGroup` of latest run for the task, `_` if no run is exists for the task.', 'name': 'workerGroup', 'required': False}, {'multipleWords': False, 'summary': '`workerId` of latest run for the task, `_` if no run is exists for the task.', 'name': 'workerId', 'required': False}, {'multipleWords': False, 'summary': '`provisionerId` this task is targeted at.', 'name': 'provisionerId', 'required': True}, {'multipleWords': False, 'summary': '`workerType` this task must run on.', 'name': 'workerType', 'required': True}, {'multipleWords': False, 'summary': '`schedulerId` this task was created by.', 'name': 'schedulerId', 'required': True}, {'multipleWords': False, 'summary': '`taskGroupId` this task was created in.', 'name': 'taskGroupId', 'required': True}, {'multipleWords': True, 'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'name': 'reserved', 'required': False}]}, *args, **kwargs)
    ...
    def taskGroupResolved(self, *args, **kwargs):
        return self._makeTopicExchange({'exchange': 'task-group-resolved', 'name': 'taskGroupResolved', 'schema': 'http://schemas.taskcluster.net/queue/v1/task-group-resolved.json#', 'routingKey': [{'multipleWords': False, 'summary': "Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key.", 'constant': 'primary', 'name': 'routingKeyKind', 'required': True}, {'multipleWords': False, 'summary': '`taskGroupId` for the task-group this message concerns', 'name': 'taskGroupId', 'required': True}, {'multipleWords': False, 'summary': '`schedulerId` for the task-group this message concerns', 'name': 'schedulerId', 'required': True}, {'multipleWords': True, 'summary': 'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.', 'name': 'reserved', 'required': False}]}, *args, **kwargs)
