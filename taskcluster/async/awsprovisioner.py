...
class AwsProvisioner(AsyncBaseClient):
    ...
    funcinfo = {
        "updateWorkerType": {           'args': [u'workerType'],
            'input': u'http://schemas.taskcluster.net/aws-provisioner/v1/create-worker-type-request.json#',
            'method': u'post',
            'name': u'updateWorkerType',
            'output': u'http://schemas.taskcluster.net/aws-provisioner/v1/get-worker-type-response.json#',
            'route': u'/worker-type/<workerType>/update',
            'stability': u'stable'},
        "getLaunchSpecs": {           'args': [u'workerType'],
            'method': u'get',
            'name': u'getLaunchSpecs',
            'output': u'http://schemas.taskcluster.net/aws-provisioner/v1/get-launch-specs-response.json#',
            'route': u'/worker-type/<workerType>/launch-specifications',
            'stability': u'experimental'},
        "listAmiSets": {           'args': [],
            'method': u'get',
            'name': u'listAmiSets',
            'output': u'http://schemas.taskcluster.net/aws-provisioner/v1/list-ami-sets-response.json#',
            'route': u'/list-ami-sets',
            'stability': u'stable'},
        "terminateAllInstancesOfWorkerType": {           'args': [u'workerType'],
            'method': u'post',
            'name': u'terminateAllInstancesOfWorkerType',
            'route': u'/worker-type/<workerType>/terminate-all-instances',
            'stability': u'experimental'},
        "instanceStarted": {           'args': [u'instanceId', u'token'],
            'method': u'get',
            'name': u'instanceStarted',
            'route': u'/instance-started/<instanceId>/<token>',
            'stability': u'stable'},
        "workerType": {           'args': [u'workerType'],
            'method': u'get',
            'name': u'workerType',
            'output': u'http://schemas.taskcluster.net/aws-provisioner/v1/get-worker-type-response.json#',
            'route': u'/worker-type/<workerType>',
            'stability': u'stable'},
        "workerTypeLastModified": {           'args': [u'workerType'],
            'method': u'get',
            'name': u'workerTypeLastModified',
            'output': u'http://schemas.taskcluster.net/aws-provisioner/v1/get-worker-type-last-modified.json#',
            'route': u'/worker-type-last-modified/<workerType>',
            'stability': u'stable'},
        "getSecret": {           'args': [u'token'],
            'method': u'get',
            'name': u'getSecret',
            'output': u'http://schemas.taskcluster.net/aws-provisioner/v1/get-secret-response.json#',
            'route': u'/secret/<token>',
            'stability': u'stable'},
        "ping": {           'args': [],
            'method': u'get',
            'name': u'ping',
            'route': u'/ping',
            'stability': u'experimental'},
        "removeAmiSet": {           'args': [u'id'],
            'method': u'delete',
            'name': u'removeAmiSet',
            'route': u'/ami-set/<id>',
            'stability': u'stable'},
        "state": {           'args': [u'workerType'],
            'method': u'get',
            'name': u'state',
            'route': u'/state/<workerType>',
            'stability': u'stable'},
        "amiSet": {           'args': [u'id'],
            'method': u'get',
            'name': u'amiSet',
            'output': u'http://schemas.taskcluster.net/aws-provisioner/v1/get-ami-set-response.json#',
            'route': u'/ami-set/<id>',
            'stability': u'stable'},
        "listWorkerTypeSummaries": {           'args': [],
            'method': u'get',
            'name': u'listWorkerTypeSummaries',
            'output': u'http://schemas.taskcluster.net/aws-provisioner/v1/list-worker-types-summaries-response.json#',
            'route': u'/list-worker-type-summaries',
            'stability': u'stable'},
        "createSecret": {           'args': [u'token'],
            'input': u'http://schemas.taskcluster.net/aws-provisioner/v1/create-secret-request.json#',
            'method': u'put',
            'name': u'createSecret',
            'route': u'/secret/<token>',
            'stability': u'stable'},
        "removeSecret": {           'args': [u'token'],
            'method': u'delete',
            'name': u'removeSecret',
            'route': u'/secret/<token>',
            'stability': u'stable'},
        "updateAmiSet": {           'args': [u'id'],
            'input': u'http://schemas.taskcluster.net/aws-provisioner/v1/create-ami-set-request.json#',
            'method': u'post',
            'name': u'updateAmiSet',
            'output': u'http://schemas.taskcluster.net/aws-provisioner/v1/get-ami-set-response.json#',
            'route': u'/ami-set/<id>/update',
            'stability': u'stable'},
        "listWorkerTypes": {           'args': [],
            'method': u'get',
            'name': u'listWorkerTypes',
            'output': u'http://schemas.taskcluster.net/aws-provisioner/v1/list-worker-types-response.json#',
            'route': u'/list-worker-types',
            'stability': u'stable'},
        "createWorkerType": {           'args': [u'workerType'],
            'input': u'http://schemas.taskcluster.net/aws-provisioner/v1/create-worker-type-request.json#',
            'method': u'put',
            'name': u'createWorkerType',
            'output': u'http://schemas.taskcluster.net/aws-provisioner/v1/get-worker-type-response.json#',
            'route': u'/worker-type/<workerType>',
            'stability': u'stable'},
        "createAmiSet": {           'args': [u'id'],
            'input': u'http://schemas.taskcluster.net/aws-provisioner/v1/create-ami-set-request.json#',
            'method': u'put',
            'name': u'createAmiSet',
            'route': u'/ami-set/<id>',
        ...
        "shutdownEverySingleEc2InstanceManagedByThisProvisioner": {           'args': [],
            'method': u'post',
            'name': u'shutdownEverySingleEc2InstanceManagedByThisProvisioner',
            'route': u'/shutdown/every/single/ec2/instance/managed/by/this/provisioner',
            'stability': u'experimental'},
        "removeWorkerType": {           'args': [u'workerType'],
            'method': u'delete',
            'name': u'removeWorkerType',
            'route': u'/worker-type/<workerType>',
            'stability': u'stable'},
        "backendStatus": {           'args': [],
            'method': u'get',
            'name': u'backendStatus',
            'output': u'http://schemas.taskcluster.net/aws-provisioner/v1/backend-status-response.json#',
            'route': u'/backend-status',
            'stability': u'experimental'},
    }


__all__ = ['createTemporaryCredentials', 'config', '_defaultConfig', 'createApiClient', 'createSession', u'AwsProvisioner']
