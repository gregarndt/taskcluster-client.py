...
class Index(AsyncBaseClient):
    ...
    **Remark**, when indexing tasks using custom routes, it's also possible
    ...
    funcinfo = {
        "findArtifactFromTask": {           'args': [u'namespace', u'name'],
            'method': u'get',
            'name': u'findArtifactFromTask',
            'route': u'/task/<namespace>/artifacts/<name>',
            'stability': u'stable'},
        "listTasks": {           'args': [u'namespace'],
            'input': u'http://schemas.taskcluster.net/index/v1/list-tasks-request.json#',
            'method': u'post',
            'name': u'listTasks',
            'output': u'http://schemas.taskcluster.net/index/v1/list-tasks-response.json#',
            'route': u'/tasks/<namespace>',
            'stability': u'stable'},
        "listNamespaces": {           'args': [u'namespace'],
            'input': u'http://schemas.taskcluster.net/index/v1/list-namespaces-request.json#',
            'method': u'post',
            'name': u'listNamespaces',
            'output': u'http://schemas.taskcluster.net/index/v1/list-namespaces-response.json#',
        ...
        "ping": {           'args': [],
            ...
            'route': u'/ping',
            'stability': u'stable'},
        "findTask": {           'args': [u'namespace'],
            'method': u'get',
            'name': u'findTask',
            'output': u'http://schemas.taskcluster.net/index/v1/indexed-task-response.json#',
            'route': u'/task/<namespace>',
            'stability': u'stable'},
        "insertTask": {           'args': [u'namespace'],
            'input': u'http://schemas.taskcluster.net/index/v1/insert-task-request.json#',
            'method': u'put',
            'name': u'insertTask',
            'output': u'http://schemas.taskcluster.net/index/v1/indexed-task-response.json#',
            'route': u'/task/<namespace>',
...
__all__ = ['createTemporaryCredentials', 'config', '_defaultConfig', 'createApiClient', 'createSession', u'Index']
