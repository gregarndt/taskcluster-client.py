...
class GithubEvents(AsyncBaseClient):
    ...
    def pullRequest(self, *args, **kwargs):
        return self._makeTopicExchange({'schema': u'http://schemas.taskcluster.net/github/v1/github-pull-request-message.json#', 'routingKey': [{u'multipleWords': False, u'required': True, u'constant': u'primary', u'name': u'routingKeyKind', u'summary': u'Identifier for the routing-key kind. This is always `"primary"` for the formalized routing key.'}, {u'multipleWords': False, u'required': True, u'name': u'organization', u'summary': u'The GitHub `organization` which had an event. All periods have been replaced by % - such that foo.bar becomes foo%bar - and all other special characters aside from - and _ have been stripped.'}, {u'multipleWords': False, u'required': True, u'name': u'repository', u'summary': u'The GitHub `repository` which had an event.All periods have been replaced by % - such that foo.bar becomes foo%bar - and all other special characters aside from - and _ have been stripped.'}, {u'multipleWords': False, u'required': True, u'name': u'action', u'summary': u'The GitHub `action` which triggered an event. See for possible values see the payload actions property.'}], 'name': u'pullRequest', 'exchange': u'pull-request'}, *args, **kwargs)
    ...
    def push(self, *args, **kwargs):
        return self._makeTopicExchange({'schema': u'http://schemas.taskcluster.net/github/v1/github-push-message.json#', 'routingKey': [{u'multipleWords': False, u'required': True, u'constant': u'primary', u'name': u'routingKeyKind', u'summary': u'Identifier for the routing-key kind. This is always `"primary"` for the formalized routing key.'}, {u'multipleWords': False, u'required': True, u'name': u'organization', u'summary': u'The GitHub `organization` which had an event. All periods have been replaced by % - such that foo.bar becomes foo%bar - and all other special characters aside from - and _ have been stripped.'}, {u'multipleWords': False, u'required': True, u'name': u'repository', u'summary': u'The GitHub `repository` which had an event.All periods have been replaced by % - such that foo.bar becomes foo%bar - and all other special characters aside from - and _ have been stripped.'}], 'name': u'push', 'exchange': u'push'}, *args, **kwargs)
    ...
    def release(self, *args, **kwargs):
        return self._makeTopicExchange({'schema': u'http://schemas.taskcluster.net/github/v1/github-release-message.json#', 'routingKey': [{u'multipleWords': False, u'required': True, u'constant': u'primary', u'name': u'routingKeyKind', u'summary': u'Identifier for the routing-key kind. This is always `"primary"` for the formalized routing key.'}, {u'multipleWords': False, u'required': True, u'name': u'organization', u'summary': u'The GitHub `organization` which had an event. All periods have been replaced by % - such that foo.bar becomes foo%bar - and all other special characters aside from - and _ have been stripped.'}, {u'multipleWords': False, u'required': True, u'name': u'repository', u'summary': u'The GitHub `repository` which had an event.All periods have been replaced by % - such that foo.bar becomes foo%bar - and all other special characters aside from - and _ have been stripped.'}], 'name': u'release', 'exchange': u'release'}, *args, **kwargs)

    funcinfo = {
    }


__all__ = ['createTemporaryCredentials', 'config', '_defaultConfig', 'createApiClient', 'createSession', u'GithubEvents']
