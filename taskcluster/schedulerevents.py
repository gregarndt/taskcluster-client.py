...
class SchedulerEvents(BaseClient):
    ...
    **Remark**, the task-graph scheduler will require that the `schedulerId`
    ...
    def taskGraphRunning(self, *args, **kwargs):
        return self._makeTopicExchange({'schema': u'http://schemas.taskcluster.net/scheduler/v1/task-graph-running-message.json#', 'routingKey': [{u'multipleWords': False, u'required': True, u'constant': u'primary', u'name': u'routingKeyKind', u'summary': u"Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key."}, {u'multipleWords': False, u'required': False, u'name': u'taskId', u'summary': u'Always takes the value `_`'}, {u'multipleWords': False, u'required': False, u'name': u'runId', u'summary': u'Always takes the value `_`'}, {u'multipleWords': False, u'required': False, u'name': u'workerGroup', u'summary': u'Always takes the value `_`'}, {u'multipleWords': False, u'required': False, u'name': u'workerId', u'summary': u'Always takes the value `_`'}, {u'multipleWords': False, u'required': False, u'name': u'provisionerId', u'summary': u'Always takes the value `_`'}, {u'multipleWords': False, u'required': False, u'name': u'workerType', u'summary': u'Always takes the value `_`'}, {u'multipleWords': False, u'required': True, u'name': u'schedulerId', u'summary': u'Identifier for the task-graphs scheduler managing the task-graph this message concerns. Usually `task-graph-scheduler` in production.'}, {u'multipleWords': False, u'required': True, u'name': u'taskGraphId', u'summary': u'Identifier for the task-graph this message concerns'}, {u'multipleWords': True, u'required': False, u'name': u'reserved', u'summary': u'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.'}], 'name': u'taskGraphRunning', 'exchange': u'task-graph-running'}, *args, **kwargs)
    ...
    def taskGraphExtended(self, *args, **kwargs):
        return self._makeTopicExchange({'schema': u'http://schemas.taskcluster.net/scheduler/v1/task-graph-extended-message.json#', 'routingKey': [{u'multipleWords': False, u'required': True, u'constant': u'primary', u'name': u'routingKeyKind', u'summary': u"Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key."}, {u'multipleWords': False, u'required': False, u'name': u'taskId', u'summary': u'Always takes the value `_`'}, {u'multipleWords': False, u'required': False, u'name': u'runId', u'summary': u'Always takes the value `_`'}, {u'multipleWords': False, u'required': False, u'name': u'workerGroup', u'summary': u'Always takes the value `_`'}, {u'multipleWords': False, u'required': False, u'name': u'workerId', u'summary': u'Always takes the value `_`'}, {u'multipleWords': False, u'required': False, u'name': u'provisionerId', u'summary': u'Always takes the value `_`'}, {u'multipleWords': False, u'required': False, u'name': u'workerType', u'summary': u'Always takes the value `_`'}, {u'multipleWords': False, u'required': True, u'name': u'schedulerId', u'summary': u'Identifier for the task-graphs scheduler managing the task-graph this message concerns. Usually `task-graph-scheduler` in production.'}, {u'multipleWords': False, u'required': True, u'name': u'taskGraphId', u'summary': u'Identifier for the task-graph this message concerns'}, {u'multipleWords': True, u'required': False, u'name': u'reserved', u'summary': u'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.'}], 'name': u'taskGraphExtended', 'exchange': u'task-graph-extended'}, *args, **kwargs)
    ...
    def taskGraphBlocked(self, *args, **kwargs):
        return self._makeTopicExchange({'schema': u'http://schemas.taskcluster.net/scheduler/v1/task-graph-blocked-message.json#', 'routingKey': [{u'multipleWords': False, u'required': True, u'constant': u'primary', u'name': u'routingKeyKind', u'summary': u"Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key."}, {u'multipleWords': False, u'required': False, u'name': u'taskId', u'summary': u'Always takes the value `_`'}, {u'multipleWords': False, u'required': False, u'name': u'runId', u'summary': u'Always takes the value `_`'}, {u'multipleWords': False, u'required': False, u'name': u'workerGroup', u'summary': u'Always takes the value `_`'}, {u'multipleWords': False, u'required': False, u'name': u'workerId', u'summary': u'Always takes the value `_`'}, {u'multipleWords': False, u'required': False, u'name': u'provisionerId', u'summary': u'Always takes the value `_`'}, {u'multipleWords': False, u'required': False, u'name': u'workerType', u'summary': u'Always takes the value `_`'}, {u'multipleWords': False, u'required': True, u'name': u'schedulerId', u'summary': u'Identifier for the task-graphs scheduler managing the task-graph this message concerns. Usually `task-graph-scheduler` in production.'}, {u'multipleWords': False, u'required': True, u'name': u'taskGraphId', u'summary': u'Identifier for the task-graph this message concerns'}, {u'multipleWords': True, u'required': False, u'name': u'reserved', u'summary': u'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.'}], 'name': u'taskGraphBlocked', 'exchange': u'task-graph-blocked'}, *args, **kwargs)
    ...
    def taskGraphFinished(self, *args, **kwargs):
        return self._makeTopicExchange({'schema': u'http://schemas.taskcluster.net/scheduler/v1/task-graph-finished-message.json#', 'routingKey': [{u'multipleWords': False, u'required': True, u'constant': u'primary', u'name': u'routingKeyKind', u'summary': u"Identifier for the routing-key kind. This is always `'primary'` for the formalized routing key."}, {u'multipleWords': False, u'required': False, u'name': u'taskId', u'summary': u'Always takes the value `_`'}, {u'multipleWords': False, u'required': False, u'name': u'runId', u'summary': u'Always takes the value `_`'}, {u'multipleWords': False, u'required': False, u'name': u'workerGroup', u'summary': u'Always takes the value `_`'}, {u'multipleWords': False, u'required': False, u'name': u'workerId', u'summary': u'Always takes the value `_`'}, {u'multipleWords': False, u'required': False, u'name': u'provisionerId', u'summary': u'Always takes the value `_`'}, {u'multipleWords': False, u'required': False, u'name': u'workerType', u'summary': u'Always takes the value `_`'}, {u'multipleWords': False, u'required': True, u'name': u'schedulerId', u'summary': u'Identifier for the task-graphs scheduler managing the task-graph this message concerns. Usually `task-graph-scheduler` in production.'}, {u'multipleWords': False, u'required': True, u'name': u'taskGraphId', u'summary': u'Identifier for the task-graph this message concerns'}, {u'multipleWords': True, u'required': False, u'name': u'reserved', u'summary': u'Space reserved for future routing-key entries, you should always match this entry with `#`. As automatically done by our tooling, if not specified.'}], 'name': u'taskGraphFinished', 'exchange': u'task-graph-finished'}, *args, **kwargs)

    funcinfo = {
    }


__all__ = ['createTemporaryCredentials', 'config', '_defaultConfig', 'createApiClient', 'createSession', u'SchedulerEvents']
