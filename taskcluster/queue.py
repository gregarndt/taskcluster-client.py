...
class Queue(BaseClient):
    ...
    funcinfo = {
        "reportException": {           'args': [u'taskId', u'runId'],
            'input': u'http://schemas.taskcluster.net/queue/v1/task-exception-request.json#',
            'method': u'post',
            'name': u'reportException',
            'output': u'http://schemas.taskcluster.net/queue/v1/task-status-response.json#',
            'route': u'/task/<taskId>/runs/<runId>/exception',
            'stability': u'stable'},
        "getLatestArtifact": {           'args': [u'taskId', u'name'],
            'method': u'get',
            'name': u'getLatestArtifact',
            'route': u'/task/<taskId>/artifacts/<name>',
            'stability': u'stable'},
        "reclaimTask": {           'args': [u'taskId', u'runId'],
            'method': u'post',
            'name': u'reclaimTask',
            'output': u'http://schemas.taskcluster.net/queue/v1/task-reclaim-response.json#',
            'route': u'/task/<taskId>/runs/<runId>/reclaim',
            'stability': u'stable'},
        "cancelTask": {           'args': [u'taskId'],
            'method': u'post',
            'name': u'cancelTask',
            'output': u'http://schemas.taskcluster.net/queue/v1/task-status-response.json#',
            'route': u'/task/<taskId>/cancel',
            'stability': u'stable'},
        "scheduleTask": {           'args': [u'taskId'],
            'method': u'post',
            'name': u'scheduleTask',
            'output': u'http://schemas.taskcluster.net/queue/v1/task-status-response.json#',
            'route': u'/task/<taskId>/schedule',
            'stability': u'stable'},
        "pollTaskUrls": {           'args': [u'provisionerId', u'workerType'],
            'method': u'get',
            'name': u'pollTaskUrls',
            'output': u'http://schemas.taskcluster.net/queue/v1/poll-task-urls-response.json#',
            'route': u'/poll-task-url/<provisionerId>/<workerType>',
            'stability': u'stable'},
        "getArtifact": {           'args': [u'taskId', u'runId', u'name'],
            'method': u'get',
            'name': u'getArtifact',
            'route': u'/task/<taskId>/runs/<runId>/artifacts/<name>',
            'stability': u'stable'},
        "ping": {           'args': [],
            'method': u'get',
            'name': u'ping',
            'route': u'/ping',
            'stability': u'stable'},
        "claimWork": {           'args': [u'provisionerId', u'workerType'],
            'input': u'http://schemas.taskcluster.net/queue/v1/claim-work-request.json#',
            'method': u'post',
            'name': u'claimWork',
            'output': u'http://schemas.taskcluster.net/queue/v1/claim-work-response.json#',
            'route': u'/claim-work/<provisionerId>/<workerType>',
            'stability': u'stable'},
        "listDependentTasks": {           'args': [u'taskId'],
            'method': u'get',
            'name': u'listDependentTasks',
            'output': u'http://schemas.taskcluster.net/queue/v1/list-dependent-tasks-response.json#',
            'query': [u'continuationToken', u'limit'],
            'route': u'/task/<taskId>/dependents',
            'stability': u'stable'},
        "status": {           'args': [u'taskId'],
            'method': u'get',
            'name': u'status',
            'output': u'http://schemas.taskcluster.net/queue/v1/task-status-response.json#',
            'route': u'/task/<taskId>/status',
            'stability': u'stable'},
        "listArtifacts": {           'args': [u'taskId', u'runId'],
            'method': u'get',
            'name': u'listArtifacts',
            'output': u'http://schemas.taskcluster.net/queue/v1/list-artifacts-response.json#',
            'query': [u'continuationToken', u'limit'],
            'route': u'/task/<taskId>/runs/<runId>/artifacts',
            'stability': u'experimental'},
        "reportFailed": {           'args': [u'taskId', u'runId'],
            'method': u'post',
            'name': u'reportFailed',
            'output': u'http://schemas.taskcluster.net/queue/v1/task-status-response.json#',
            'route': u'/task/<taskId>/runs/<runId>/failed',
            'stability': u'stable'},
        "listLatestArtifacts": {           'args': [u'taskId'],
            'method': u'get',
            'name': u'listLatestArtifacts',
            'output': u'http://schemas.taskcluster.net/queue/v1/list-artifacts-response.json#',
            'query': [u'continuationToken', u'limit'],
            'route': u'/task/<taskId>/artifacts',
            'stability': u'experimental'},
        "defineTask": {           'args': [u'taskId'],
            'input': u'http://schemas.taskcluster.net/queue/v1/create-task-request.json#',
            'method': u'post',
            'name': u'defineTask',
            'output': u'http://schemas.taskcluster.net/queue/v1/task-status-response.json#',
            'route': u'/task/<taskId>/define',
            'stability': u'deprecated'},
        "createTask": {           'args': [u'taskId'],
            'input': u'http://schemas.taskcluster.net/queue/v1/create-task-request.json#',
            'method': u'put',
            'name': u'createTask',
            'output': u'http://schemas.taskcluster.net/queue/v1/task-status-response.json#',
        ...
        "task": {           'args': [u'taskId'],
            'method': u'get',
            'name': u'task',
            'output': u'http://schemas.taskcluster.net/queue/v1/task.json#',
            'route': u'/task/<taskId>',
            'stability': u'stable'},
        "pendingTasks": {           'args': [u'provisionerId', u'workerType'],
            'method': u'get',
            'name': u'pendingTasks',
            'output': u'http://schemas.taskcluster.net/queue/v1/pending-tasks-response.json#',
            'route': u'/pending/<provisionerId>/<workerType>',
            'stability': u'stable'},
        "reportCompleted": {           'args': [u'taskId', u'runId'],
            'method': u'post',
            'name': u'reportCompleted',
            'output': u'http://schemas.taskcluster.net/queue/v1/task-status-response.json#',
            'route': u'/task/<taskId>/runs/<runId>/completed',
            'stability': u'stable'},
        "rerunTask": {           'args': [u'taskId'],
            'method': u'post',
            'name': u'rerunTask',
            'output': u'http://schemas.taskcluster.net/queue/v1/task-status-response.json#',
            'route': u'/task/<taskId>/rerun',
            'stability': u'deprecated'},
        "listTaskGroup": {           'args': [u'taskGroupId'],
            'method': u'get',
            'name': u'listTaskGroup',
            'output': u'http://schemas.taskcluster.net/queue/v1/list-task-group-response.json#',
            'query': [u'continuationToken', u'limit'],
            'route': u'/task-group/<taskGroupId>/list',
            'stability': u'stable'},
        "createArtifact": {           'args': [u'taskId', u'runId', u'name'],
            'input': u'http://schemas.taskcluster.net/queue/v1/post-artifact-request.json#',
            'method': u'post',
            'name': u'createArtifact',
            'output': u'http://schemas.taskcluster.net/queue/v1/post-artifact-response.json#',
            'route': u'/task/<taskId>/runs/<runId>/artifacts/<name>',
            'stability': u'stable'},
        "claimTask": {           'args': [u'taskId', u'runId'],
            'input': u'http://schemas.taskcluster.net/queue/v1/task-claim-request.json#',
            'method': u'post',
            'name': u'claimTask',
            'output': u'http://schemas.taskcluster.net/queue/v1/task-claim-response.json#',
            'route': u'/task/<taskId>/runs/<runId>/claim',
            'stability': u'stable'},
    }


__all__ = ['createTemporaryCredentials', 'config', '_defaultConfig', 'createApiClient', 'createSession', u'Queue']
